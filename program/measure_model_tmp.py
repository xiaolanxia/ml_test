...
class MyThread(threading.Thread):
    ...
    def run(self):
        os.system("docker run -it -e DEV=10.244.48.45:0 -v /home/wanbo/measure/program/change_env_program:/home  --workdir /home --rm 10.244.48.135:5000/wanbo_measure:v2 /home/%s" % (self.name))
